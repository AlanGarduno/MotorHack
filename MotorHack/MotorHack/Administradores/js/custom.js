...
function charts() {
	...
	{
	    var d1 = []; //= [[1, 2], [2, 1], [3, 2], [4, 2], [5, 1], [6, 2], [7, 2], [8, 1], [9, 2],];
		...
		function plotWithOptions() {
			$.plot($("#stackchart"), [ d1], {
				...
				legend: { show: true },
				xaxis: { autoscaleMargin: 0.1, max: 31 },//, min:1, max:31
	...
	/* ---------- Pie chart ---------- */
	var data = [
    { label: "Filtros de Aceite", data: 70 },
    { label: "Anticongelantes", data: 170 },
    { label: "Bombas de Gas", data: 24 },
    { label: "Aceites", data: 205 },
	{ label: "Bujias",  data: 90},
	{ label: "Calipers", data: 60 },
    { label: "Llantas", data: 125 },
    { label: "Filtros de Aire", data: 50 },
    { label: "Amortiguadores", data: 88 },
    { label: "Rines", data: 37 },
    { label: "Suspensiones", data: 40 }
	];
