<%@ Page Title="" Language="C#" MasterPageFile="~/Clientes/Cliente.Master" AutoEventWireup="true" CodeBehind="FiltrosAire.aspx.cs" Inherits="MotorHack.Clientes.Productos.FiltrosAire" %>
    ...
    <script type="text/javascript">
        function agregarCarrito(precio_venta, p_nombre, p_cantidad, p_descripcion,p_id_producto) {
            ...
            jQuery.ajax({
                type        : "GET",
                url         : "../acciones.aspx",
                data        : { accion : "agregar_filtroAire", id_producto: p_id_producto,nombre:p_nombre, cantidad: t_cantidad, precio:precio_venta},
