<%@ Page Title="" Language="C#" MasterPageFile="~/Clientes/Cliente.Master" AutoEventWireup="true" CodeBehind="BombasGasolina.aspx.cs" Inherits="MotorHack.Clientes.Productos.BombasGasolina" %>
    ...
    <script type="text/javascript">
        function agregarCarrito(precio_venta, p_nombre, p_cantidad, p_descripcion,p_id_producto) {
            ...
            jQuery.ajax({
                type        : "GET",
                url         : "../acciones.aspx",
                data        : { accion : "agregar_bombasGasolina", id_producto: p_id_producto,nombre:p_nombre, cantidad: t_cantidad, precio:precio_venta},
